...
//  jiosinema
//
//  Created by R & W on 23/05/23.
//

import UIKit

class premium:UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) ->
        UICollectionViewCell {
            if collectionView == self.collectionView1MoviePage                                                                   {
                ...
                let cellMovie99 = collectionView9MoviePage.dequeueReusableCell(withReuseIdentifier:  "cellMovie99", for: indexPath) as! CollectionViewCellForMovie9
                
                cellMovie99.img.image =
